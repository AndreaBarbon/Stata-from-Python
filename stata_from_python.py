...
#
# Mac:
STATA_APP_MAC = "/Applications/Stata/StataMP.app/Contents/MacOS/StataMP"
#
# Windows:
STATA_APP_WIN = "C:\Program Files (x86)\Stata14\StataMP-64.exe"
#
#
...
if 'darwin' in platform: WINDOWS   = False; STATA_APP = STATA_APP_MAC
else :                   WINDOWS   = True;  STATA_APP = STATA_APP_WIN
